package com.nagp.diningservice.exception;

import com.nagp.diningservice.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleHttpMessageNotReadableException(
        ...
        String errorMessage = "Request body is missing or cannot be read"+ex.getMessage();
